...
static const char *fonts[]     n     = {"Iosevka:style:medium:size=12" ,"JetBrainsMono Nerd Font Mono:style:medium:size=19" };
...
static const int attachbelow = 1;     /* 1 means attach after currently active window */
